...
- Bagaimana denganmu, siapa namamu dan mengapa kamu ke wilayah sungai ini?#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
...
Kejadian yang sungguh aneh, mungkinkah ini berkaitan dengan hal mistis ? #speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
...
Sebelum itu, bisakah kamu menyampaikan pesan kepada anakku samosir?#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
Setelah itu aku akan menemuimu di rumahku, Samosir akan memberitahu kepadamu jalannya.#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right

+[Tentu]
Tentu, aku bisa membantu kamu. Apa yang kamu butuhkan? #speaker:<color=\#E17220>Adi</color> #potrait:Player#layout:left
Terima kasih! Aku sangat berterima kasih. Aku ingin kamu mengantarkan pesanku kepada anakku, Samosir.#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
Dia biasanya berkeliaran di sekitar hutan ini. Tolong beri tahu dia untuk pulang.#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
->chosen("Selesai")
+[Ragu]
Aku tidak yakin bisa membantu, tetapi aku akan mencoba.#speaker:<color=\#E17220>Adi</color> #potrait:Player#layout:left
Tidak masalah. Tolong, jika kamu melihat anakku, Samosir, beri tahu dia untuk pulang #speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
->chosen("Selesai")
+[Tidak]
...
=== alreadyChose ===
bertemu lagi kita <color=\#E17220>Adi</color> #speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
{
	- choiceMake == "Selesai":
		Tolong beri tahu samosir untuk pulang, dan berhati hati lah kawan #speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
	- choiceMake == "Postpone":
		->ChooseNo
}
->END
...
=== ChooseNo ==
Bagaimana, apakah kau bisa membantuku#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
	 +[Tentu]
		    Tentu, aku bisa membantu kamu. Apa yang kamu butuhkan?#speaker:<color=\#E17220>Adi</color> #potrait:Player#layout:left
		    Terima kasih! Aku sangat berterima kasih. Aku ingin kamu mengantarkan pesanku kepada anakku, Samosir. #speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
		    Dia biasanya berkeliaran di sekitar hutan ini. Tolong beri tahu dia untuk pulang.#speaker:<color=\#88BDFF>Toba</color> #potrait:Toba #layout:right
